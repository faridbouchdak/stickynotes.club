...
> **[VERIFY V-02] Resolved on 20 July 2026; link boundary revised under D-23 on 23 July 2026** — Use this archive lifecycle when the feature is designed and implemented. Do not present board archiving as an existing capability until it has shipped. When an active board is archived, active View and Post links may show only the read-only archived board; Post links cannot accept new sticky notes. The Owner may still revoke either link.
