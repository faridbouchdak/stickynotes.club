...
- **Q-02 — current-value editing:** edits overwrite the current value and no history or recovery table was found in the schema. This matches the approved no-history model. Verification with autosave, failures and conflicts cannot be completed until V-04 exists.
...
- **E-02 — terminology and British English:** non-canonical **Member** labels in the application interface, including the board templates identified during review, were replaced with **Participant** on 23 July 2026. The broader Help Centre, policy, permalink and British-English audit remains open.
...
- **V-04 — collaboration reliability:** no WebSocket-based synchronisation, autosave or conflict handling was found. Real-time claims must remain unpublished or explicitly qualified.
...
4. Remove or qualify real-time claims until V-04 is implemented and tested.
5. **Application cleanup completed on 23 July 2026:** non-canonical **Member** labels replaced with **Participant**. The wider E-02 content and policy audit remains open.
...
1. **E-02 — terminology and British English.** Audit the Help Centre, policies and interface copy for non-canonical role labels, US spelling, old permalinks, configurable-permission claims and share-link wording that no longer matches revised D-23. The five design documents already define the intended replacements; contextual mentions of rejected terms may remain when clearly labelled.
