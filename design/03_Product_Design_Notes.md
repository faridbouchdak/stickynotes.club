...
> **[DECISION D-29] Resolved on 3 August 2026; rollout pending** — The planned public plan ladder is **Club Member → Club Host → Club Facilitator → Chosen Few**. Club Member replaces Free, Club Host replaces Premium, Club Facilitator is new, and Chosen Few retains its name. Existing entitlements remain unchanged until a separately specified and verified rollout.
