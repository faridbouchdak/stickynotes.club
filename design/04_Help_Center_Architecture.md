...
The Help Centre must also distinguish ownership by context. Users retain ownership of content they create or share inside private boards. Publishing a sticky note or Instant Photo to the worldwide wall explicitly relinquishes ownership of that Public content without transferring it to StickyNotes.club. The country snapshot is the only origin information shown; the private internal relationship used for author controls and moderation is not public attribution and does not preserve ownership after publication. Explain this before **Publish** and in the Sticky notes, Privacy & safety and FAQ guides, subject to legal and policy alignment under D-28.
